...
static uint8_t AW8697_HAPTIC_RAM_VBAT_COMP_GAIN = 0x3B;
...
/* tongfeng.Huang@BSP.CHG.Basic, 2018/11/17,  Add for config trig1 */
    ...
    {"aw8697_reserved_channel_RTP_53.bin"},
...
/* used for coloros 7 */
    {"aw8697_Appear_channel_RTP_coloros7_123.bin"},	//浮现
    {"aw8697_Miss_RTP_coloros7_124.bin"},	//思念
    {"aw8697_Music_channel_RTP_coloros7_125.bin"},	//乐音
    {"aw8697_Percussion_channel_RTP_coloros7_126.bin"}, //敲击
    {"aw8697_Ripple_channel_RTP_coloros7_127.bin"},	//涟漪
    {"aw8697_Bright_channel_RTP_coloros7_128.bin"},	//透亮
    {"aw8697_Fun_channel_RTP_coloros7_129.bin"},	//趣味
    {"aw8697_Glittering_channel_RTP_coloros7_130.bin"},	//闪烁
    {"aw8697_Harp_channel_RTP_coloros7_131.bin"},	//竖琴
    {"aw8697_Overtone_channel_RTP_coloros7_132.bin"},	//泛音
    {"aw8697_Simple_channel_RTP_coloros7_133.bin"}, //简单

    {"aw8697_Seine_past_RTP_coloros7_134.bin"},	//塞纳河往事
    {"aw8697_Classical_ring_RTP_coloros7_135.bin"},	//经典
    {"aw8697_Long_for_RTP_coloros7_136.bin"},	//憧憬
    {"aw8697_Romantic_RTP_coloros7_137.bin"},	//浪漫
    {"aw8697_Bliss_RTP_coloros7_138.bin"}, //收获幸福
    {"aw8697_Dream_RTP_coloros7_139.bin"},	//追寻梦想
    {"aw8697_Relax_RTP_coloros7_140.bin"},	//缓和
    {"aw8697_Joy_channel_RTP_coloros7_141.bin"},	//愉悦
         ...
         unsigned char reg_addr, unsigned char reg_data)
{
    ...
    if (reg_addr == 0x04 || reg_addr == 0x05) {
        pr_err("%s: reg_addr_0x%02x = 0x%02x\n", __func__, reg_addr, reg_data);
    }
...
static int aw8697_ram_update(struct aw8697 *aw8697)
{
    ...
    //173 174,174
    //>175 ,174
    if (aw8697->f0 < OPPO_F0_VAL_MIN || aw8697->f0 > OPPO_F0_VAL_MAX) {
        aw8697->f0 = 1700;
    }
        ...
        const char *buf, size_t count)
{
    ...
    pr_err("%s:  f0 = %d\n", __FUNCTION__, val);
    if (val >= OPPO_F0_VAL_MIN && val <= OPPO_F0_VAL_MAX) {
        aw8697->f0 = val;
    } else {
        aw8697->f0 = 1700;
    }
