 ...
 * VENDOR_EDIT
 * File       : novatek_drivers_nt36672c.c
...
//			strlcpy(tmp_version, panel_data->manufacture_info.version, panel_data->version_len+1);
...
//              strlcat(tmp_version, dev_version, panel_data->version_len +3);
                strlcat(tmp_version, dev_version, strlen(panel_data->manufacture_info.version)+3);
                strlcpy(panel_data->manufacture_info.version, tmp_version,  strlen(panel_data->manufacture_info.version)+3);
            } else {
