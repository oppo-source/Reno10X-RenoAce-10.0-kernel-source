...
int __attribute__((weak)) oppo_get_fg_device_type(void)
{
	return 0;
}

void __attribute__((weak)) oppo_set_fg_device_type(int device_type)
{
	return;
}
...
static void bq27541_hw_config(struct chip_bq27541 *chip)
{
	...
	oppo_set_fg_device_type(chip->device_type);
...
static int bq28z610_get_2cell_voltage(void)
{
	...
	/*chg_err("batt_cell_1_vol = %dmV, batt_cell_2_vol = %dmV, \
		batt_cell_max_vol = %dmV\n",
