...
#ifndef __OPPO_MP2650_H__

#define __OPPO_MP2650_H__
...
#define REG07_MP2650_PRECHARGE_THRESHOLD_5800MV                0
...
#define REG12_MP2650_INPUT_OVA_THRESHOLD_MASK                  (BIT(6) | BIT(5) | BIT(4) | BIT(3) | BIT(2) | BIT(1) | BIT(0))
#define REG12_MP2650_INPUT_OVA_THRESHOLD_SHIFT                 0
...
extern int oppo_chg_get_shutdown_soc(void);
extern int oppo_chg_backup_soc(int backup_soc);
